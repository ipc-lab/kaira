...
def test_style_loss_custom_layer_weights():
    ...
    feature_preds = {"relu1_2": torch.randn(2, 64, 32, 32), "relu2_2": torch.randn(2, 128, 16, 16), "relu3_3": torch.randn(2, 256, 8, 8)}

    feature_targets = {"relu1_2": torch.randn(2, 64, 32, 32), "relu2_2": torch.randn(2, 128, 16, 16), "relu3_3": torch.randn(2, 256, 8, 8)}

    # Define custom layer weights
    layer_weights = {"relu1_2": 0.1, "relu2_2": 0.2, "relu3_3": 0.7}
