...
class TestVanillaGANLoss:
    ...
    def test_forward_discriminator(self):
        ...
        expected_real_loss = F.binary_cross_entropy_with_logits(real_logits, torch.ones_like(real_logits))
        expected_fake_loss = F.binary_cross_entropy_with_logits(fake_logits, torch.zeros_like(fake_logits))
    ...
    def test_forward_generator(self):
        ...
        # Verify loss calculation
        expected_loss = F.binary_cross_entropy_with_logits(fake_logits, torch.ones_like(fake_logits))
