...
class TestConstellationPlotting:
    ...
    def test_annotation_handling(self):
        ...
        fig, ax = plot_constellation(constellation, labels=labels, annotate=True, title="Test Constellation")
        ...
        short_labels = ["00", "01"]
        fig, ax = plot_constellation(constellation, labels=short_labels, annotate=True)
    ...
    def test_no_annotation(self):
        ...
        fig, ax = plot_constellation(constellation, labels=labels, annotate=False)
    ...
    def test_existing_axes_provided(self):
        ...
        fig, ax = plot_constellation(constellation, ax=existing_ax)  # Pass the existing axes here
