...
from kaira.modulations.dpsk import DPSKModulator, DPSKDemodulator
from kaira.modulations.identity import IdentityModulator, IdentityDemodulator
    ...
    def test_modulator_demodulator_pairs(self):
        ...
        for mod_name, demod_name, params in modulation_pairs:
            ...
            assert modulator.bits_per_symbol == demodulator.bits_per_symbol, \
                f"bits_per_symbol mismatch for {mod_name}/{demod_name}"
            ...
            if not isinstance(modulator, DPSKModulator):
                ...
                if mod_name in ["bpskmodulator", "qpskmodulator"]:
                    ...
                    assert symbols.shape[0] == expected_symbol_count, \
                        f"Unexpected symbol count for {mod_name}"
