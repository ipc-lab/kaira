import pytest
import torch
from kaira.losses.image import MSELoss, CombinedLoss, MSELPIPSLoss, LPIPSLoss, SSIMLoss, MSSSIMLoss, L1Loss, VGGLoss, TotalVariationLoss, GradientLoss, PSNRLoss, StyleLoss, FocalLoss, ElasticLoss
