        ...
        if isinstance(module_config, (list, nn.ModuleList)):
            ...
            if shared:
                ...
                if num_devices == 1:
                     ...
                     raise ValueError(f"A single {module_name} instance was provided, but shared_{module_name.lower()}=False and num_devices={num_devices}. "
                                      f"Set shared_{module_name.lower()}=True if you intend to share the instance, "
                                      f"or provide a class/list if you need separate instances.")
