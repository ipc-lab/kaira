...
class DeepJSCCQEncoder(BaseModel):
    ...
    def __init__(self, N: int, M: int) -> None:
        '''The function initializes a neural network model with a series of residual blocks and attention
        blocks.
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        '''The forward function applies a series of layers to the input tensor and returns the final
        output.
...
class DeepJSCCQDecoder(nn.Module):
    def __init__(self, N: int, M: int) -> None:
        '''The function initializes a neural network model with a series of attention blocks and residual
        blocks for image processing.
    ...
    def forward(self, x):
        '''The forward function applies a series of layers to the input x and returns the final output.
