...
class DeepJSCCQ2Encoder(nn.Module):
    ...
    def __init__(self, N: int, M: int, csi_length: int = 1) -> None:
        '''The function initializes a neural network model with a specific architecture consisting of
        residual blocks, attention blocks, and activation function modules.
    ...
    def forward(self, x):
        '''The forward function takes an input x and passes it through a series of layers in self.g_a,
        applying an AFModule layer if encountered, and returns the final output.
...
class DeepJSCCQ2Decoder(nn.Module):
    ...
    def __init__(self, N: int, M: int, csi_length: int = 1) -> None:
        '''The function initializes a neural network model with a specific architecture consisting of
        attention blocks, residual blocks, and AF modules.
    ...
    def forward(self, x):
        '''The function takes an input x and passes it through a series of layers, applying an activation
        function if the layer is an AFModule.
