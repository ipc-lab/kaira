...
This module contains the WynerZivPipeline, which implements distributed source coding
...
class WynerZivCorrelationModel(nn.Module):
    ...
    This module is used to simulate how side information is related to the source
    in a Wyner-Ziv coding system. In practice, different correlation models can be
    implemented depending on the application domain.
    """
