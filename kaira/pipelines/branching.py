...
class BranchingPipeline(BasePipeline):
    ...
    Each branch has a condition that determines if it should process the input.
    Only the first matching branch (or default) will be executed.
    """
    ...
    def remove_step(self, index: int):
        """Not applicable to branching pipeline."""
        raise NotImplementedError("Cannot remove steps directly from BranchingPipeline. Use branch names instead.")
