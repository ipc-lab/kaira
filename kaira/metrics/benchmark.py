...
class MetricBenchmark:
    ...
    def __init__(
        self, metrics: Dict[str, BaseMetric], device: Optional[Union[str, torch.device]] = None
    ):
    ...
    def run_speed_benchmark(
        self, input_shapes: List[Tuple[int, ...]], repeat: int = 5, warmup: int = 2
    ) -> Dict[str, Any]:
    ...
    def run_accuracy_benchmark(
        self, reference_data: Dict[str, Tensor], test_data: Dict[str, Tensor]
    ) -> Dict[str, Any]:
    ...
    def generate_report(self, path: Optional[str] = None) -> str:
        ...
        if "accuracy" in self._results:
            ...
            report.append("")
            report.append(
                "| Metric | Computed Value | Reference Value | Difference | Relative Difference |"
            )
            report.append(
                "|--------|---------------|----------------|------------|---------------------|"
            )
...
def demonstrate_benchmark():
    ...
    """
    from .image import LPIPS, PSNR, SSIM
    ...
    shapes = [(1, 3, 64, 64), (1, 3, 128, 128), (4, 3, 64, 64), (4, 3, 128, 128)]
