...
class BlockErrorRate(BaseMetric):
    ...
    This metric calculates the ratio of blocks with errors to the total number of blocks.
    A block is considered erroneous if any bit/symbol within the block is incorrect.
    
    BLER is commonly used in communication systems to evaluate the performance of
    channel coding schemes, especially in scenarios with burst errors.
    """
