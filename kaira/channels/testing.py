...
def measure_snr_vs_param(channel_factory: Callable[[float], BaseChannel],
                         param_values: List[float],
                         param_name: str,
                         input_signal: torch.Tensor,
                         num_trials: int = 5) -> Tuple[List[float], List[float], List[float]]:
...
def plot_snr_vs_param(param_values: List[float], 
    ...
    ax.errorbar(param_values, snr_means, yerr=snr_stds, 
...
def plot_ber_vs_snr(ber_results: Dict[float, float],
