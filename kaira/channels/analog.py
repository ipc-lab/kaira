...
This module provides implementations of channels with continuous inputs,
supporting both real and complex-valued signals. These channels represent
various types of noise and distortions found in analog communication systems.
"""

import torch

from kaira.utils import to_tensor, snr_to_noise_power
from .base import BaseChannel
from .utils import _apply_noise
import numpy as np
...
class NonlinearChannel(BaseChannel):
    ...
    def __init__(self, nonlinear_fn, add_noise=False, avg_noise_power=None, snr_db=None, 
                 complex_mode='direct'):
        super().__init__()
