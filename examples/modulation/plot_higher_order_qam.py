...
plot_constellation(qam4_symbols.flatten(), 
...
plot_constellation(qam16_symbols.flatten(), 
...
plot_constellation(qam64_symbols.flatten(), 
...
plot_constellation(qam256_symbols.flatten(), 
...
plot_constellation(received.flatten(),
                 title=f'4-QAM at {snr_4qam} dB SNR',
                 marker='.',
                 ax=axs[0, 0])
axs[0, 0].grid(True)
...
plot_constellation(received.flatten(),
                 title=f'16-QAM at {snr_16qam} dB SNR',
                 marker='.',
                 ax=axs[0, 1])
axs[0, 1].grid(True)
...
plot_constellation(received.flatten(),
                 title=f'64-QAM at {snr_64qam} dB SNR',
                 marker='.',
                 ax=axs[1, 0])
axs[1, 0].grid(True)
...
plot_constellation(received.flatten(),
                 title=f'256-QAM at {snr_256qam} dB SNR',
                 marker='.',
                 ax=axs[1, 1])
axs[1, 1].grid(True)
